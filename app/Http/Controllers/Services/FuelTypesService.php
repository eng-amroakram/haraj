...
class FuelTypesService extends Controller
{
    public $name = "نوع الوقود";
    public $title_creator = "إضافة نوع وقود جديد";
    public $title_updater = "تعديل بيانات نوع الوقود";
    public $modal_size = "";
    public $creator_id = "creator-feature-button";
    public $updater_id = "updater-feature-button";
    public $model = FuelType::class;
    ...
    {
        return FuelType::getRules($id);
    }

    public function messages($id = "")
    {
        return FuelType::getMessages($id);
    }


    public function delete($id)
    {
        return FuelType::deleteModel($id);
    }

    public function status($id)
    {
        return FuelType::status($id);
    }

    public function store($data)
    {
        return FuelType::store($data);
    }

    public function update($data, $id)
    {
        return FuelType::updateModel($data, $id);
    }
