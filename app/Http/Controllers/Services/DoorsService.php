...
class DoorsService extends Controller
{
    public $name = "عدد الأبواب";
    public $title_creator = "إضافة عدد أبواب جديد";
    public $title_updater = "تعديل بيانات عدد الأبواب";
    public $modal_size = "";
    public $creator_id = "creator-feature-button";
    public $updater_id = "updater-feature-button";
    public $model = Door::class;
    ...
    {
        return Door::getRules($id);
    }

    public function messages($id = "")
    {
        return Door::getMessages($id);
    }


    public function delete($id)
    {
        return Door::deleteModel($id);
    }

    public function status($id)
    {
        return Door::status($id);
    }

    public function store($data)
    {
        return Door::store($data);
    }

    public function update($data, $id)
    {
        return Door::updateModel($data, $id);
    }
